...
static std::vector<uint8_t> HexToBytes(const std::string hex) {
  if (hex.size() % 2 != 0) {
    throw std::invalid_argument(
        "Invalid input string, length must be multple of 2");
  }
...
std::vector<jsi::PropNameID> JsiBip39::getPropertyNames(jsi::Runtime &rt) {
  ...
  result.push_back(
      jsi::PropNameID::forUtf8(rt, std::string("generateMnemonic")));
  result.push_back(
      jsi::PropNameID::forUtf8(rt, std::string("validateMnemonic")));
  result.push_back(
      jsi::PropNameID::forUtf8(rt, std::string("mnemonicToEntropy")));
  result.push_back(
      jsi::PropNameID::forUtf8(rt, std::string("entropyToMnemonic")));
  result.push_back(jsi::PropNameID::forUtf8(rt, std::string("mnemonicToSeed")));
  result.push_back(
      jsi::PropNameID::forUtf8(rt, std::string("mnemonicToSeedHex")));
  return result;
}

jsi::Value JsiBip39::get(jsi::Runtime &runtime,
  ...
  if (propName == "generateMnemonic") {
    return jsi::Function::createFromHostFunction(
        ...
        [](jsi::Runtime &runtime, const jsi::Value &Value,
          ...
          if (count > 0) {
            ...
            if (!arguments[0].isNull() && !arguments[0].isUndefined()) {
              ...
              if (!arguments[0].isNumber()) {
                throw jsi::JSError(runtime, "First argument must be a number "
                                            "representing the entropy size!");
              }
          ...
          if (count > 1) {
            ...
            if (!arguments[1].isNull() && !arguments[1].isUndefined()) {
              ...
              if (!isTypedArray(runtime, object)) {
                throw jsi::JSError(
                    runtime,
                    "Second argument must be a Uint8Array representing rng!");
              }
              ...
              // generate entropy
              int bits_ent = bip39::Mnemonic::GetEntBitsByNumMnemonicSentences(
                  entropySize);
          ...
          if (count > 2) {
            ...
            if (!arguments[2].isNull() && !arguments[2].isUndefined()) {
              ...
              if (!arguments[2].isString()) {
                throw jsi::JSError(runtime, "Third argument must be a string "
          ...
          std::string mnemonic_sentences =
              bip39::GenerateWords(word_list, bip39::GetDelimiterByLang(lang));
        ...
        [](jsi::Runtime &runtime, const jsi::Value &Value,
          ...
          if (count > 0) {
            if (!arguments[0].isString()) {
              throw jsi::JSError(
                  runtime,
                  "First argument must be a string representing a mnemoic!");
            }
          }
  ...
  if (propName == "mnemonicToEntropy") {
    return jsi::Function::createFromHostFunction(
        ...
        [](jsi::Runtime &runtime, const jsi::Value &Value,
          ...
          std::string mnemonics = arguments[0].asString(runtime).utf8(runtime);
          std::vector<std::string> word_list = bip39::ParseWords(
              mnemonics, bip39::GetDelimiterByLang(
                             lang)); // assuming space is the delimiter
        ...
        [](jsi::Runtime &runtime, const jsi::Value &Value,
          ...
          if (count > 0) {
            ...
            if (arguments[0].isString()) {
              ...
              auto typedArray =
                  getTypedArray(runtime, arguments[0].asObject(runtime));
              entropy = typedArray.toVector(
                  runtime); // Use the Uint8Array directly as bytes
            } else {
              throw jsi::JSError(
                  runtime, "First argument must be a string or a Uint8Array!");
            }

            // Validate entropy size
            if (entropy.size() % 4 != 0 || entropy.size() > 1024) {
              throw jsi::JSError(runtime,
                                 "Invalid entropy: size must be a multiple of "
